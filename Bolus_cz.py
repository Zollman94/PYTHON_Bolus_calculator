...
def update_display_value():
    global carbs, fats, proteins, grams, bolustotal, bolusfats, boluscarbs
    display_value1.config(text=f"Celkove: {bolustotal}")
...
# Proteins
label_proteins = tk.Label(root, text="Bilkoviny:")
...
#label title
label = tk.Label(root, text="Bolus kalkulacka")
label.place(x=50, y=20)
#label total bolus
display_value1 = tk.Label(root, text="Celkove: ")
display_value1.place(x=200, y=20)
#label bolus for carbs
display_value2 = tk.Label(root, text="Za sacharidy: ")
display_value2.place(x=200, y=40)
#label bolus for fats
display_value3 = tk.Label(root, text="Za tuky:")
...
#exit button
exit_button = tk.Button(root, text="Konec", command=exit_program)
exit_button.place(x=200, y=120)
#calc button
calculate_button = tk.Button(root, text="Vypocitej", command=save_values)
